      ...
      <motion.section initial={{opacity:0, y:50}} animate={{opacity: 1, y: 0 }}
        className=' py-16 px-4 text-center relative'>
          <div className=' max-w-4xl mx-auto'>
            <motion.h1 className=' text-5xl sm:text-6xl md:text-7xl font-bold mb-4 font-serif bg-clip-text
          ...
          {features.map((f,i) => {
            ...
            return (
              ...
              transition={{ delay: i * 0.2 }} className=' relative group'>
                 <div className=' absolute -inset-1 bg-gradient-to-br from-amber-600/30 to-amber-500/30 rounded
                 ...
                 border border-amber-600/30 hover:border-amber-500 transition-all duration-300 h-full'>
                  <div className=' RELATIVE H-64 Overflow-hidden'>
                    <motion.img src={f.img} alt={f.tittle}  className=' w-full h-full object-cover'
                    initial={{ scale : 1 }} whitrHover={{ scale : 1.05 }} transition={{ duration : 0.4 }}/>
                  ...
                  <div className=' p-8'>
                    ...
                    <h3 className=' text-2xl font-nlod mb-2 text-amber-100'>{f.tittle} </h3>

                   <p className=' text-amber-100/18'> {f.text}</p>
           ...
           {stats.map((s,i) =>{
             ...
             return (
                    ...
                    whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.2, type: 'spring' }}
                      className=' relative group h-48' onHoverStart={() => setHoverdStat(i)}
                      ...
                      animate={{
                        ...
                        <motion.div className=' absolute inset-0' animate={{
                          ...
                          rounded-xl border-2 border-amber-600/30 p-6 overflow-hidden transition-all duration-300'>
                            <motion.div className=' absolute inset-0 rounded-x1'
                             animate = {{
      background: [
        ...
        'linear-gradient(45deg, #3c2a21 0%, #1a120b 50%, #3c2a21 100%)'
                            ...
                            shadow-amber-900/20 '/>
                            <div className=' relative z-10 h-full flex flex-co; items-center justify-center'>
                          ...
                          <motion.div className=' abolute inset-0 bg-amber-900/10 rounded-xl'
                          initial= {{opacity: 0}}
        ...
        <div className=' max-w-7xl mx-auto'>
          <motion.h2 initial={{opacity:0, y: 20 }}
           ...
           className=' text-4xl font-serif sm:text-5xl md:text-6xl font-bold text-center mb-12 text-amber-100'>
             Meet Our <span className=' text-amber-500'> Campus Crave</span>
          ...
          <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12'>
            {teamMembers.map((m,i) => (
              ...
              transition={{delay: m.delay }} className=' relative group'>
                <div className=' relative h-full bg-[33c2a21]/90 backdrop-blur-lg rounded-3xl overfloe-hidden
                border-2 border-amber-600/30 hover:shadow-amber-500 transiton-all duration-500 shadow-
                hover:shadow-2xl hover:shadow-amber-500/20 '>
                  ...
                  <div className=' p-8 text-center flex flex-col h-[cal(100%-24rem)]'>
                    <div className=' mb-4'>
                      <h3 className=' text-3xl font-bold m-2 text-amber-100'>{m.name}</h3>
