    ...
    <div className='min-h-screen bg-gradient-to-br from-[#1a120b] via-[#3c2a21] to-[#1a120b] text-amber-50 overflow-hidden relative'>
      ...
      >
        <div className='max-w-4xl mx-auto'>
          <motion.h1
            className='text-5xl sm:text-6xl md:text-7xl font-bold mb-4 font-serif bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-600'
          >
            Campus Crave
          </motion.h1>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12'>
            {teamMembers.map((m, i) => (
              <motion.div
                ...
                className='relative group'
              >
                <div className='relative h-full bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl overflow-hidden border-2 border-amber-600/30 hover:shadow-amber-500 transition-all duration-500 shadow hover:shadow-2xl hover:shadow-amber-500/20'>
                  ...
                  <div className='p-8 text-center flex flex-col h-[calc(100%-24rem)]'>
                    ...
                    <motion.div className='flex justify-center gap-4 pt-6' initial={{ scale: 0 }} whileInView={{ scale: 1 }}>
                      {Object.entries(m.social).map(([p, url]) => (
                        ...
                        >
                          {p === 'twitter' && <FaXTwitter className='w-6 h-6' />}
                          {p === 'instagram' && <FaInstagram className='w-6 h-6' />}
                          {p === 'facebook' && <FaFacebookF className='w-6 h-6' />}
                          {p === 'linkedin' && <FaLinkedinIn className='w-6 h-6' />}
                        </a>
                      ))}
                    </motion.div>
                  </div>
