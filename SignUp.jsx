...
import { FaArrowAltCircleDown, FaArrowLeft, FaArrowRight, FaCheckCircle, FaEye, FaEyeSlash } from 'react-icons/fa';
import { Link, useNavigate } from 'react-router-dom';


const AwesomeToast = ({ message, icon }) => (
  <div className=' animate-slide-in fixed bottom-6 flex items-center bg-gradient-to-br from-amber-500 to-amber-600
    ...
    <div className=' min-h-screen flex items-center justify-center bg-[#1a120b] p-4'>
      ...
      <div className=' w-full max-w-md bg-gradient-to-br from-[$2D1B0E] to-[#4a372a] p-8 rounded-xl shadow-lg
        ...
        <form onSubmit={handleSubmit} className=' space-y-4'>
          ...
          font-bold rounded-lg hover:scale-105 transition-tranform duration-300 hover:shadow-lg'>
            Sign Up
